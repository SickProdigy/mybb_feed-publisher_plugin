...
function feedpublisher_install()
{
    ...
    if (!$db->table_exists('feedpublisher_feeds')) {
        $db->write_query("CREATE TABLE `" . TABLE_PREFIX . "feedpublisher_feeds` (
            ...
            `require_entry_body` tinyint(1) NOT NULL DEFAULT 1,
            `require_entry_media` tinyint(1) NOT NULL DEFAULT 0,
            `media_mode` varchar(16) NOT NULL DEFAULT 'fallback_image',
            `media_position` varchar(8) NOT NULL DEFAULT 'top',
            `publication_mode` varchar(16) NOT NULL DEFAULT 'automatic',
            `fulltext_mode` varchar(16) NOT NULL DEFAULT 'summary',
            `fulltext_fallback` varchar(12) NOT NULL DEFAULT 'feed',
            `fulltext_url_regex` varchar(255) NOT NULL DEFAULT '',
            `fulltext_url_replacement` varchar(2048) NOT NULL DEFAULT '',
            ...
            `interval_minutes` smallint unsigned NOT NULL DEFAULT 240,
            `publish_interval_minutes` smallint unsigned NOT NULL DEFAULT 360,
...
function feedpublisher_upgrade_schema()
{
    ...
    $columns = array(
        ...
        'require_entry_body' => "tinyint(1) NOT NULL DEFAULT 1 AFTER `maximum_source_age_days`",
        'require_entry_media' => "tinyint(1) NOT NULL DEFAULT 0 AFTER `require_entry_body`",
        'media_mode' => "varchar(16) NOT NULL DEFAULT 'fallback_image' AFTER `require_entry_media`",
        'media_position' => "varchar(8) NOT NULL DEFAULT 'top' AFTER `media_mode`",
        'publication_mode' => "varchar(16) NOT NULL DEFAULT 'automatic' AFTER `media_position`",
        'fulltext_mode' => "varchar(16) NOT NULL DEFAULT 'summary' AFTER `publication_mode`",
        'fulltext_fallback' => "varchar(12) NOT NULL DEFAULT 'feed' AFTER `fulltext_mode`",
        'fulltext_url_regex' => "varchar(255) NOT NULL DEFAULT '' AFTER `fulltext_fallback`",
        'fulltext_url_replacement' => "varchar(2048) NOT NULL DEFAULT '' AFTER `fulltext_url_regex`",
        'fulltext_summary_chars' => "smallint unsigned NOT NULL DEFAULT 600 AFTER `fulltext_url_replacement`",
        'fulltext_max_per_run' => "tinyint unsigned NOT NULL DEFAULT 3 AFTER `fulltext_summary_chars`",
        'interval_minutes' => "smallint unsigned NOT NULL DEFAULT 240 AFTER `enabled`",
        'publish_interval_minutes' => "smallint unsigned NOT NULL DEFAULT 360 AFTER `interval_minutes`",
